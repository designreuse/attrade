...
public class SeamCarverPictureSqueezer {
     ...
     */
    public SeamCarverPictureSqueezer(Picture picture) {
    ...
    public int[] findHorizontalSeam() {
        ...
        // Visit all pixels from the top, diagonally to the right side,
    ...
    public void removeHorizontalSeam(int[] seam) {
        ...
        // Check for bad input
        if (height() <= 1)
            throw new IllegalArgumentException("Picture too short");
    ...
    public void removeVerticalSeam(int[] seam) {
        ...
        // Check for bad input
        if (width() <= 1)
            throw new IllegalArgumentException("Picture too narrow");
        if (seam == null) throw new NullPointerException();
