...
<div class="parts-navbar-navbar">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">     <!-- размер и цветовая схема-->
            ...
            <ul class="navbar-nav mr-auto"> <!-- ul - список; mr-auto - автоматически генерируемое меню-->
                <li class="nav-item"> <!-- элементы меню -->
                    <div class="btn-group btn-group-md" role="group" aria-label="Basic example">
                        <button type="submit" role="button" href="/product" class="btn btn-secondary">Каталог</button>
                    </div>
        ...
        <div class="btn-group btn-group-md" role="group" aria-label="Order">
            <form action="/watch" method="get">
                <button type="submit" role="button" class="btn btn-secondary mr-sm-1"><i class="fas fa-eye"
                                                                                 aria-hidden="true">
                </i>
                </button>
            </form>
            <form action="/history" method="get">
                <button type="submit" role="button" class="btn btn-secondary mr-sm-1"><i class="fas fa-history"
                                                                                 aria-hidden="true"></i>
                <#if principalUser??>
            ...
            <form action="/basket" method="get">
                <button type="submit" role="button" class="btn btn-secondary"><i
